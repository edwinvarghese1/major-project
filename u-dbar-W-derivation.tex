...
$$
	d\sigma  =  \frac{1}{4\hat{s}}\left(\frac{G_FM_W^2}{\sqrt{2}}\right)^2|V_\text{ud}|^2 \frac{64 \hat{t}^2}{(p^2-M_W^2)^2 +M_W^2\Gamma_W^2}d\Phi_{2},
$$

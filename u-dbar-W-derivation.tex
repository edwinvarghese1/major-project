...
\end{equation}
According to Table 3 in \cite{ATLAS:2016fij}, the measured cross-section of $W^+ \rightarrow l\nu$ from proton-proton collision at the same centre-of-mass energy is $\sigma = 11.83 \pm 0.02$. The central value from the result in \ref{pp} agrees with this value within 5.1\%, yet, one can see immediately the values have large uncertainty, and thus is not a precise prediction. This stems from the nature of the...

...
%\begin{figure}[tb]
%	\centering 
%	\includegraphics[width=0.9\linewidth]{graphics/comparison-plots}
%	\caption{Comparison of \texttt{SciPy}, Basic Monte Carlo, and \texttt{VEGAS} integration methods in the context of PDF convolution with the total partonic cross-section.}

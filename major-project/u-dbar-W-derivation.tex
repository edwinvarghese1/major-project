...
$$\sigma =\frac{1}{2}\frac{\sqrt{2}}{3}G_FM^2_W(2\pi)^4\frac{1}{(2\pi)^32E_W}2M_W\delta(\hat{s} - M_W^2), $$
...
\begin{equation}
	\sigma =\frac{\pi \sqrt{2}}{3}G_FM^2_W\delta(\hat{s} - M_W^2).
\end{equation}
...
This can be accomplished through the identity,
...
$$
 ...
 \begin{equation}
 	\Gamma(W^+ \rightarrow e^+ \nu_e)= frac{1}{2M_W} \left(\frac{1}{3}g^2 M_W^2\right) \frac{1}{8\pi} = \frac{1}{48}g^2M_W
 \end{equation}
